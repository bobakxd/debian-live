...
static const char *colors[][3]      = {
	...
	[SchemeInfoSel]  = { col_subtext0, col_crust,  col_overlay0  }, // infobar middle  selected {text,background,not used but cannot be empty}
	[SchemeInfoNorm]  = { col_text, col_crust,  col_overlay0  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_crust, "-nf", col_text, "-sb", col_green, "-sf", col_base, NULL };
